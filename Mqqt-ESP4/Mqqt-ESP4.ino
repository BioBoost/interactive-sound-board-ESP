...
// LED
u8 m_color[5][3] = { {255, 0, 0}, {0, 255, 0}, {0, 0, 255}, {255, 255, 255}, {255, 255, 0} };
...
const char* sensor_topic = "test/soundboard/esp4"; // Topic we send to
const char* mqtt_username = "test_esp4"; // MQTT username
const char* mqtt_password = "test_esp4"; // MQTT password
const char* clientID = "client_soundboard_esp4"; // MQTT client ID
