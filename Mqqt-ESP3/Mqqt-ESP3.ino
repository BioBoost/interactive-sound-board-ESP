...
const char* sensor_topic = "test/soundboard/esp3"; // Topic we send to
const char* mqtt_username = "test_esp3"; // MQTT username
const char* mqtt_password = "test_esp3"; // MQTT password
const char* clientID = "client_soundboard_esp3"; // MQTT client ID
...
void connect_MQTT(){
  ...
  */
  if (client.connect(clientID, mqtt_username, mqtt_password)) {
    Serial.println("Connected to MQTT Broker!");
    strip.setLedColorData(0, m_color[3][0], m_color[3][1], m_color[3][2]);
    strip.show();
